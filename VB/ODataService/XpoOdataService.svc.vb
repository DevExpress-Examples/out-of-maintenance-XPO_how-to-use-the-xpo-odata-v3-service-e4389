...
Namespace XpoODataExample
    ...
    Public Class XpoODataExampleService
        ...
        Private Shared ReadOnly _context As New XpoODataContext("XpoExampleContext", "Northwind", CreateDataLayer())

        Public Sub New()
            MyBase.New(_context, _context)
        End Sub
        ...
        Public Shared Sub InitializeService(ByVal config As DataServiceConfiguration)
            ...
            config.AnnotationsBuilder = CreateAnnotationsBuilder(Function() _context)
        ...
        Public Function OnQueryActors() As Expression(Of Func(Of Categories, Boolean))
            If _context.CategoriesFiltering Then
        ...
        Public Function GetAuthorizationCookie(ByVal name As String, ByVal password As String) As String
            Using uow As New UnitOfWork(Context.ObjectLayer)
                ...
                If contact Is Nothing Then
                    Return String.Empty
                End If
                Dim ticket As New FormsAuthenticationTicket(1, contact.LastName, Date.Now, Date.Now.AddMinutes(30), True, contact.EmployeeID.ToString())
        ...
        Public Sub SetCategoriesFiltering(ByVal state As Boolean)
            _context.CategoriesFiltering = state
        End Sub
    End Class
End Namespace
