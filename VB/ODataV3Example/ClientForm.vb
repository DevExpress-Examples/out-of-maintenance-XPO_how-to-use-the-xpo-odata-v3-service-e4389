...
Namespace ODataV3Example.Northwind
    Partial Public Class ClientForm
        ...
        Private _listObjects As IList
        Private Property ListObjects() As IList
            Get
                Return _listObjects
            End Get
            Set(ByVal value As IList)
                If _listObjects IsNot Nothing Then
                    For Each entity As INotifyPropertyChanged In _listObjects
                ...
                If _listObjects IsNot Nothing Then
                    ...
                    Next entity
                End If
                gclODataV3ServiceMain.DataSource = _listObjects
        ...
        Private Sub GetAnnotation()
            ...
            For Each annotation As IEdmVocabularyAnnotation In annotatedModel.VocabularyAnnotations
                ...
                Select Case term.Name
                    Case "Size"
                        annotations(entityTypeName)([property].Name).Size = CInt(CType(valueAnnotation.Value, IEdmIntegerValue).Value)
                    Case "ReadOnly"
