...
Namespace ODataV3Example.Northwind
    ...
    Partial Public Class XpoExampleContext
        ...
        ''' </summary>
        <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Services.Design", "1.0.0")>
        Public Sub AddToCustomers(ByVal _customers As Customers)
            MyBase.AddObject("Customers", _customers)
        End Sub
        ''' <summary>
        ''' There are no comments for Products in the schema.
        ''' </summary>
        <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Services.Design", "1.0.0")>
        Public Sub AddToProducts(ByVal _products As Products)
            MyBase.AddObject("Products", _products)
        End Sub
        ''' <summary>
        ''' There are no comments for Categories in the schema.
        ''' </summary>
        <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Services.Design", "1.0.0")>
        Public Sub AddToCategories(ByVal _categories As Categories)
            MyBase.AddObject("Categories", _categories)
        End Sub
        ''' <summary>
        ''' There are no comments for Employees in the schema.
        ''' </summary>
        <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Services.Design", "1.0.0")>
        Public Sub AddToEmployees(ByVal _employees As Employees)
            MyBase.AddObject("Employees", _employees)
        End Sub
        ''' <summary>
        ''' There are no comments for Shippers in the schema.
        ''' </summary>
        <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Services.Design", "1.0.0")>
        Public Sub AddToShippers(ByVal _shippers As Shippers)
            MyBase.AddObject("Shippers", _shippers)
        End Sub
        ''' <summary>
        ''' There are no comments for Orders in the schema.
        ''' </summary>
        <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Services.Design", "1.0.0")>
        Public Sub AddToOrders(ByVal _orders As Orders)
            MyBase.AddObject("Orders", _orders)
        End Sub
        ''' <summary>
        ''' There are no comments for Suppliers in the schema.
        ''' </summary>
        <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Services.Design", "1.0.0")>
        Public Sub AddToSuppliers(ByVal _suppliers As Suppliers)
            MyBase.AddObject("Suppliers", _suppliers)
        End Sub
    End Class
    ''' <summary>
    ...
    ''' CustomerID
    ''' </KeyProperties>
    <Global.System.Data.Services.Common.EntitySetAttribute("Customers"), Global.System.Data.Services.Common.DataServiceKeyAttribute("CustomerID")>
    Partial Public Class Customers
        ...
        Public Shared Function CreateCustomers(ByVal customerID As String) As Customers
            Dim _customers As New Customers()
            _customers.CustomerID = customerID
            Return _customers
        End Function
        ''' <summary>
    ...
    Partial Public Class Categories
        ...
        Public Shared Function CreateCategories(ByVal categoryID As Integer, ByVal streamPicture As Global.System.Data.Services.Client.DataServiceStreamLink) As Categories
            ...
            _categories.StreamPicture = streamPicture
            Return _categories
        End Function
        ''' <summary>
    ...
    ''' EmployeeID
    ''' </KeyProperties>
    <Global.System.Data.Services.Common.EntitySetAttribute("Employees"), Global.System.Data.Services.Common.DataServiceKeyAttribute("EmployeeID")>
    Partial Public Class Employees
        ...
        Public Shared Function CreateEmployees(ByVal employeeID As Integer, ByVal photo As Global.System.Data.Services.Client.DataServiceStreamLink) As Employees
            Dim _employees As New Employees()
            _employees.EmployeeID = employeeID
            _employees.Photo = photo
            Return _employees
        End Function
        ''' <summary>
        ''' There are no comments for Property Address in the schema.
    ...
    ''' ShipperID
    ''' </KeyProperties>
    <Global.System.Data.Services.Common.EntitySetAttribute("Shippers"), Global.System.Data.Services.Common.DataServiceKeyAttribute("ShipperID")>
    Partial Public Class Shippers
        ...
        Public Shared Function CreateShippers(ByVal shipperID As Integer) As Shippers
            Dim _shippers As New Shippers()
            _shippers.ShipperID = shipperID
            Return _shippers
        End Function
        ''' <summary>
        ''' There are no comments for Property CompanyName in the schema.
    ...
    ''' OrderID
    ''' </KeyProperties>
    <Global.System.Data.Services.Common.EntitySetAttribute("Orders"), Global.System.Data.Services.Common.DataServiceKeyAttribute("OrderID")>
    ...
    ''' SupplierID
    ''' </KeyProperties>
    <Global.System.Data.Services.Common.EntitySetAttribute("Suppliers"), Global.System.Data.Services.Common.DataServiceKeyAttribute("SupplierID")>
    Partial Public Class Suppliers
        ...
        Public Shared Function CreateSuppliers(ByVal supplierID As Integer) As Suppliers
            Dim _suppliers As New Suppliers()
            _suppliers.SupplierID = supplierID
            Return _suppliers
        End Function
        ''' <summary>
        ''' There are no comments for Property Address in the schema.
